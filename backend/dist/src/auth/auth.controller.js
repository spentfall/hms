...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'User registration', description: 'Create new patient account and return JWT token' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Registration successful, returns JWT token' }),
