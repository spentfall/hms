...
let AppointmentsController = class AppointmentsController {
    ...
    async findOne(id, req) {
        ...
        if (req.user.role === client_1.Role.DOCTOR && appointment.doctorId !== req.user.profileId) {
            throw new common_1.ForbiddenException('You can only access your own appointments');
        }
        if (req.user.role === client_1.Role.PATIENT && appointment.patientId !== req.user.profileId) {
            throw new common_1.ForbiddenException('You can only access your own appointments');
        }
        return appointment;
    }
    async findDoctorAppointments(id, req) {
        if (req.user.role === client_1.Role.DOCTOR && req.user.profileId !== id) {
            throw new common_1.ForbiddenException('You can only access your own appointments');
        }
        return this.appointmentsService.findDoctorAppointments(id);
    }
    async findPatientAppointments(id, req) {
        if (req.user.role === client_1.Role.PATIENT && req.user.profileId !== id) {
            throw new common_1.ForbiddenException('You can only access your own records');
        }
...
__decorate([
    (0, common_1.Post)(),
    (0, roles_decorator_1.Roles)(client_1.Role.ADMIN, client_1.Role.PATIENT),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], AppointmentsController.prototype, "findDoctorAppointments", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], AppointmentsController.prototype, "findPatientAppointments", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, roles_decorator_1.Roles)(client_1.Role.ADMIN, client_1.Role.DOCTOR),
    __param(0, (0, common_1.Param)('id')),
